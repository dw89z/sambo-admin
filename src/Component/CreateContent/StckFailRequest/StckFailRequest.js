...
export default class extends React.Component {
  ...
  tableComp = () => {
    const { departureprocessinglist, errorSearch } = this.state;
          ...
          <table>
            <thead>
              <tr>
                ...
                <th onClick={inputs.sortBy} className="th-sort" id="use_lot_no">
                  사용자재 LOT
                </th>
                <th onClick={inputs.sortBy} className="th-sort" id="out_lot_no">
                  제조 LOT
                </th>
                ...
                <th>4M</th>
                <th onClick={inputs.sortBy} className="th-sort" id="issue_date">
                  변경일자
                </th>
                <th onClick={inputs.sortBy} className="th-sort" id="eo_no">
                  EO.NO
                </th>
                <th onClick={inputs.sortBy} className="th-sort" id="packtype">
                  용기 TYPE
                </th>
                <th onClick={inputs.sortBy} className="th-sort" id="packqty">
                  적입량
                </th>
                <th>행 삭제</th>
              </tr>
              ...
              {departureprocessinglist.map((list, index) => {
                return (
                  <tr
                    ...
                    id={`row${index}`}
                  >
                    <td className={list.copied ? "balseq copied" : "balseq"}>
                      {list.balseq}
                    </td>
                    <td>
                      <input
                    ...
                    <td>
                      <input
                        ...
                        placeholder={list.checked ? "사용자재 LOT" : undefined}
                      />
                    </td>
                    <td>
                      <input
